async function fetchData() {
    try {
        ...
        const datared = data['svod'][0]
        const datamid = data['svod'][1]
        const datagreen = data['svod'][2]
    ...
    function createTable(data, maxRowsPerColumn, tableTitle, tableContainer) {
        ...
        data.forEach((item, index) => {
            ...
            if (!headerAdded && rowCount === 0) {
                ...
                headerRow.innerHTML = `<th>№</th><th>Субъект</th><th>Красная/Желтая<br>/Зеленая зоны</br></th><th>ДК*</th>`;
